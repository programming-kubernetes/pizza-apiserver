...
import (
	...
	scheme "github.com/programming-kubernetes/custom-apiserver/pkg/generated/clientset/internalversion/scheme"
...
type FlunderInterface interface {
	Create(*custom.Flunder) (*custom.Flunder, error)
	Update(*custom.Flunder) (*custom.Flunder, error)
	UpdateStatus(*custom.Flunder) (*custom.Flunder, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*custom.Flunder, error)
	List(opts v1.ListOptions) (*custom.FlunderList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *custom.Flunder, err error)
	FlunderExpansion
}
...
func newFlunders(c *CustomClient, namespace string) *flunders {
	return &flunders{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *flunders) Get(name string, options v1.GetOptions) (result *custom.Flunder, err error) {
	result = &custom.Flunder{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("flunders").
		Name(name).
...
func (c *flunders) List(opts v1.ListOptions) (result *custom.FlunderList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &custom.FlunderList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("flunders").
...
func (c *flunders) Create(flunder *custom.Flunder) (result *custom.Flunder, err error) {
	result = &custom.Flunder{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("flunders").
...
func (c *flunders) Update(flunder *custom.Flunder) (result *custom.Flunder, err error) {
	result = &custom.Flunder{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("flunders").
...
func (c *flunders) UpdateStatus(flunder *custom.Flunder) (result *custom.Flunder, err error) {
	result = &custom.Flunder{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("flunders").
...
func (c *flunders) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *custom.Flunder, err error) {
	result = &custom.Flunder{}
