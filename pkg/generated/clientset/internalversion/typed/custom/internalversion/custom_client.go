...
// NewForConfigOrDie creates a new CustomClient for the given config and
// panics if there is an error in the config.
func NewForConfigOrDie(c *rest.Config) *CustomClient {
...
// New creates a new CustomClient for the given RESTClient.
func New(c rest.Interface) *CustomClient {
...
func setConfigDefaults(config *rest.Config) error {
	...
	if config.GroupVersion == nil || config.GroupVersion.Group != scheme.Scheme.PrioritizedVersionsForGroup("custom.programming-kubernetes.info")[0].Group {
		gv := scheme.Scheme.PrioritizedVersionsForGroup("custom.programming-kubernetes.info")[0]
...
func (c *CustomClient) RESTClient() rest.Interface {
	if c == nil {
		return nil
	}
	return c.restClient
