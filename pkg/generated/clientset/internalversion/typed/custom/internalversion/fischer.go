...
type FischerInterface interface {
	Create(*custom.Fischer) (*custom.Fischer, error)
	Update(*custom.Fischer) (*custom.Fischer, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*custom.Fischer, error)
	List(opts v1.ListOptions) (*custom.FischerList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *custom.Fischer, err error)
	FischerExpansion
}
...
func newFischers(c *CustomClient) *fischers {
	return &fischers{
		client: c.RESTClient(),
	}
}
...
func (c *fischers) Get(name string, options v1.GetOptions) (result *custom.Fischer, err error) {
	result = &custom.Fischer{}
	err = c.client.Get().
		Resource("fischers").
		Name(name).
...
func (c *fischers) List(opts v1.ListOptions) (result *custom.FischerList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &custom.FischerList{}
	err = c.client.Get().
		Resource("fischers").
...
func (c *fischers) Create(fischer *custom.Fischer) (result *custom.Fischer, err error) {
	result = &custom.Fischer{}
	err = c.client.Post().
		Resource("fischers").
		Body(fischer).
...
func (c *fischers) Update(fischer *custom.Fischer) (result *custom.Fischer, err error) {
	result = &custom.Fischer{}
	err = c.client.Put().
		Resource("fischers").
		Name(fischer.Name).
...
func (c *fischers) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *custom.Fischer, err error) {
	result = &custom.Fischer{}
