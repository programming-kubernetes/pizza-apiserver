...
import (
	...
	scheme "github.com/programming-kubernetes/custom-apiserver/pkg/generated/clientset/versioned/scheme"
...
type PizzaInterface interface {
	Create(*v1alpha1.Pizza) (*v1alpha1.Pizza, error)
	Update(*v1alpha1.Pizza) (*v1alpha1.Pizza, error)
	UpdateStatus(*v1alpha1.Pizza) (*v1alpha1.Pizza, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.Pizza, error)
	List(opts v1.ListOptions) (*v1alpha1.PizzaList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.Pizza, err error)
	PizzaExpansion
}
...
func (c *pizzas) Get(name string, options v1.GetOptions) (result *v1alpha1.Pizza, err error) {
...
func (c *pizzas) List(opts v1.ListOptions) (result *v1alpha1.PizzaList, err error) {
...
func (c *pizzas) Create(pizza *v1alpha1.Pizza) (result *v1alpha1.Pizza, err error) {
	result = &v1alpha1.Pizza{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("pizzas").
...
func (c *pizzas) Update(pizza *v1alpha1.Pizza) (result *v1alpha1.Pizza, err error) {
	result = &v1alpha1.Pizza{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("pizzas").
...
func (c *pizzas) UpdateStatus(pizza *v1alpha1.Pizza) (result *v1alpha1.Pizza, err error) {
	result = &v1alpha1.Pizza{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("pizzas").
...
func (c *pizzas) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.Pizza, err error) {
	result = &v1alpha1.Pizza{}
