...
type FakeFlunders struct {
	Fake *FakeCustomV1beta1
	ns   string
}

var flundersResource = schema.GroupVersionResource{Group: "custom.programming-kubernetes.info", Version: "v1beta1", Resource: "flunders"}

var flundersKind = schema.GroupVersionKind{Group: "custom.programming-kubernetes.info", Version: "v1beta1", Kind: "Flunder"}
