...
import (
	...
	customv1alpha1 "github.com/programming-kubernetes/custom-apiserver/pkg/apis/custom/v1alpha1"
	...
	v1alpha1 "github.com/programming-kubernetes/custom-apiserver/pkg/generated/listers/custom/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CustomV1alpha1().Flunders(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CustomV1alpha1().Flunders(namespace).Watch(options)
			},
		},
		&customv1alpha1.Flunder{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *flunderInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&customv1alpha1.Flunder{}, f.defaultInformer)
}
