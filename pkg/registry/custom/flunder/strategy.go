...
import (
	...
	"github.com/programming-kubernetes/custom-apiserver/pkg/apis/custom/validation"
...
func GetAttrs(obj runtime.Object) (labels.Set, fields.Set, bool, error) {
	apiserver, ok := obj.(*custom.Flunder)
	if !ok {
...
func SelectableFields(obj *custom.Flunder) fields.Set {
