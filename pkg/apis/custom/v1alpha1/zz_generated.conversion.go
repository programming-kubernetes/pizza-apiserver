...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*Policy)(nil), (*custom.Policy)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_Policy_To_custom_Policy(a.(*Policy), b.(*custom.Policy), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*custom.Policy)(nil), (*Policy)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_custom_Policy_To_v1alpha1_Policy(a.(*custom.Policy), b.(*Policy), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*PolicyList)(nil), (*custom.PolicyList)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_PolicyList_To_custom_PolicyList(a.(*PolicyList), b.(*custom.PolicyList), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*custom.PolicyList)(nil), (*PolicyList)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_custom_PolicyList_To_v1alpha1_PolicyList(a.(*custom.PolicyList), b.(*PolicyList), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_Policy_To_custom_Policy(in *Policy, out *custom.Policy, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
	out.DisallowedFlunders = *(*[]string)(unsafe.Pointer(&in.DisallowedFlunders))
	return nil
}

// Convert_v1alpha1_Policy_To_custom_Policy is an autogenerated conversion function.
func Convert_v1alpha1_Policy_To_custom_Policy(in *Policy, out *custom.Policy, s conversion.Scope) error {
	return autoConvert_v1alpha1_Policy_To_custom_Policy(in, out, s)
}

func autoConvert_custom_Policy_To_v1alpha1_Policy(in *custom.Policy, out *Policy, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
	out.DisallowedFlunders = *(*[]string)(unsafe.Pointer(&in.DisallowedFlunders))
	return nil
}

// Convert_custom_Policy_To_v1alpha1_Policy is an autogenerated conversion function.
func Convert_custom_Policy_To_v1alpha1_Policy(in *custom.Policy, out *Policy, s conversion.Scope) error {
	return autoConvert_custom_Policy_To_v1alpha1_Policy(in, out, s)
}

func autoConvert_v1alpha1_PolicyList_To_custom_PolicyList(in *PolicyList, out *custom.PolicyList, s conversion.Scope) error {
	out.ListMeta = in.ListMeta
	out.Items = *(*[]custom.Policy)(unsafe.Pointer(&in.Items))
	return nil
}

// Convert_v1alpha1_PolicyList_To_custom_PolicyList is an autogenerated conversion function.
func Convert_v1alpha1_PolicyList_To_custom_PolicyList(in *PolicyList, out *custom.PolicyList, s conversion.Scope) error {
	return autoConvert_v1alpha1_PolicyList_To_custom_PolicyList(in, out, s)
}

func autoConvert_custom_PolicyList_To_v1alpha1_PolicyList(in *custom.PolicyList, out *PolicyList, s conversion.Scope) error {
	out.ListMeta = in.ListMeta
	out.Items = *(*[]Policy)(unsafe.Pointer(&in.Items))
	return nil
}

// Convert_custom_PolicyList_To_v1alpha1_PolicyList is an autogenerated conversion function.
func Convert_custom_PolicyList_To_v1alpha1_PolicyList(in *custom.PolicyList, out *PolicyList, s conversion.Scope) error {
	return autoConvert_custom_PolicyList_To_v1alpha1_PolicyList(in, out, s)
}
