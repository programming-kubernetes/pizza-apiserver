...
mkdir -p ${goPath}/src/github.com/programming-kubernetes/custom-apiserver
cp -R . ${goPath}/src/github.com/programming-kubernetes/custom-apiserver

pushd ${goPath}/src/github.com/programming-kubernetes/custom-apiserver
rm -rf vendor || true
...
mv ${goPath}/src/github.com/programming-kubernetes/custom-apiserver/vendor .
mv ${goPath}/src/github.com/programming-kubernetes/custom-apiserver/Godeps .
git add vendor
git add Godeps
