...
# 3. rewrite the history on that branch to *only* include staging/src/github.com/programming-kubernetes/custom-apiserver
...
# this command rewrite git history to *only* include staging/src/github.com/programming-kubernetes/custom-apiserver
git filter-branch -f --subdirectory-filter staging/src/github.com/programming-kubernetes/custom-apiserver HEAD
